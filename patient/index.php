                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Ingin melihhat semua janjianmu? Coba buka
                                <a href="doctors.php" class="non-style-link"><b>"Semua Dokter"</b></a> atau
                                <a href="schedule.php" class="non-style-link"><b>"Janjian"</b> </a><br>
                                Lihat semua janjian dahulumu.<br>Dan juga lihat jadwal janjian dokter atau konsultan kesehatan anda.<br><br>
                            </p>
                            
                            <h3>Cari doktermu disini</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Ketik nama Dokternya dan kita akan mencarikan jadwal yang tersedia" list="doctors" style="width:45%;">&nbsp;&nbsp;
                        ...
                        <table border="0" width="100%"">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="font-size: 20px;font-weight:600;padding-left: 40px;" class="anime">Janjian Selanjutnya</p>
                                    <center>
